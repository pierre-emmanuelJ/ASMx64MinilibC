...
** Last update Wed Apr 12 12:16:07 2017 Pierre-Emmanuel Jacquier
*/
...
int main()
{
  ...
  *s1 = 0;
  ...
  assert(!strcmp(my_memmove(out1, test11, 5), memmove(out2, test22, 5)));
  ...
  assert(!strcmp(my_memmove(test11, test11 + 2, 5), memmove(test22, test22 + 2, 5)));
  ...
  assert(!strcmp(my_memmove(test11 + 2, test11, 5), memmove(test22 + 2, test22, 5)));
